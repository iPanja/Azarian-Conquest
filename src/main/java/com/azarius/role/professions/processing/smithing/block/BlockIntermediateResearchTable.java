...
public class BlockIntermediateResearchTable extends Block implements IHasModel, ITileEntityProvider{
	public BlockIntermediateResearchTable() {
		super(Material.ROCK);
		this.setUnlocalizedName("blockIresearchtable");
		this.setRegistryName(Reference.MODID, "BlockIResearchTable");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TileEntityIResearchTable();
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote) {
			playerIn.openGui(AzarianConquest.instance, GuiHandler.IRESEARCHTABLE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
